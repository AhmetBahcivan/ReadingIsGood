    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        try {
            ...
            if (jwt!=null && tokenProvider.validateJwtToken(jwt)) {
                Customer customer = tokenProvider.getUserFromJwtToken(jwt);

                //UserDetails userDetails = new UserDetails();
                UserDetailsImpl userDetails = new UserDetailsImpl(customer.getId(), customer.getUsername(), customer.getEmail(), "");
